  ...
  return (
    <View className="flex-1 bg-black px-4 pt-16">
      ...
      <View className="flex-row items-center mb-8">
        ...
        <Text className="text-white text-xl font-sans-bold ml-4">Sign In</Text>
      </View>
      ...
      <View className="space-y-4">
        ...
        >
          <Text className="text-black font-sans-bold">{loading ? "Signing in..." : "Sign In"}</Text>
        </Pressable>
        ...
        >
          <Text className="text-zinc-400">
            ...
            <Text className="text-white font-sans-medium">Sign Up</Text>
          </Text>
        </Pressable>
      </View>
    </View>
